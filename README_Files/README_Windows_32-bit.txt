...
2. Place `AnimalDetectSorter_windows_386.exe` in the same folder as your coco_labels JSON file and images.

Running the Executable:
1. Double-click `AnimalDetectSorter_windows_386.exe` to run.
