AnimalDetectSorter - Windows 32-bit

Unpacking and Placement:
1. Download and unzip the file.
2. Place `sorting_script_Windows_32bit.exe` in the same folder as your coco_labels JSON file and images.

Running the Executable:
1. Double-click `sorting_script_Windows_32bit.exe` to run.
2. If nothing happens, try running as administrator:
   - Right-click on the file and select "Run as administrator".
   - Or, open PowerShell in the folder and run:
     .\sorting_script_Windows_32bit.exe
