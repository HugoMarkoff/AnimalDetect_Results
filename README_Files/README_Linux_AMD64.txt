AnimalDetectSorterScripts - Linux 64-bit

Unpacking and Placement:
1. Download and unzip the file.
2. Place `sorting_script_linux_amd64` in the same folder as your coco_labels JSON file and images.

Running the Executable:
1. Open a terminal and navigate to the folder containing the file.
2. Run the following command to make it executable:
   chmod +x sorting_script_linux_amd64
3. Run the sorter with:
   ./sorting_script_linux_amd64
