AnimalDetectSorter - macOS (Apple Silicon)

Unpacking and Placement:
1. Download and unzip the file.
2. Place `sorting_script_macOS_Apple_Silicone` in the same folder as your coco_labels JSON file(s).

Running the Executable:
1. Open a terminal and navigate to the folder containing the file.
2. Run the following command to make it executable:
   chmod +x sorting_script_macOS_Apple_Silicone
3. Run the sorter with:
   ./sorting_script_macOS_Apple_Silicone
